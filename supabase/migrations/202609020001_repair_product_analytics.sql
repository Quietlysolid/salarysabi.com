-- Start a clean, privacy-safe reporting period for the PAYE-to-payslip funnel.
-- Event rows contain only an allow-listed action, public path and referrer host.
