...
const updates = [
  {
    ...
    title: "2026 PAYE rules verified",
    ...
    source: "Nigeria Tax Act 2025, Chapter Two; JRB Personal Income Tax Guidelines 2026, paragraphs 8–9 and Appendix 1.",
