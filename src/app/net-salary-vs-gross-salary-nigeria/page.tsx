...
export default function NetSalaryGuidePage() {
  return <PublicPageShell>
    ...
    <article className="simple-guide salary-article">
      <header className="simple-guide-hero"><span className="eyebrow">Salary explained</span><h1>Gross pay vs take-home pay</h1><Link className="primary-button" href="/payslip-checker">Calculate take-home pay</Link></header>
