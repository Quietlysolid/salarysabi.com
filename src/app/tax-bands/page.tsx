...
export default function TaxBandsPage() {
  return <PublicPageShell>
    ...
    <article className="simple-guide tax-bands-page">
      <header className="simple-guide-hero"><span className="eyebrow">2026 PAYE rates</span><h1>Nigeria tax bands</h1><Link className="primary-button" href="/payslip-checker">Calculate take-home pay</Link></header>
